...
def sunrise_sunset(latitude,longitude,d,t=0.5,timezone=0):
    ...
    solarAzimuthAngleSolarNoon = ((solarAzimuthAngleSunset - solarAzimuthAngleSunrise)/2) + solarAzimuthAngleSunrise
    ...
    if solarNoon  < 0:
        solarNoonDate -= timedelta(days = 1)
    elif solarNoon > 1:
        solarNoonDate += timedelta(days = 1)
    solarNoon = solarNoon % 1
    ...
    # Solarnoon time calculation
    solarNoonHour = int(24.0*solarNoon)
    solarNoonMinute = int((24.0*solarNoon-solarNoonHour)*60)
    solarNoonSecond = int(((24.0*solarNoon-solarNoonHour)*60-solarNoonMinute)*60)
    solarNoonHMS = time(solarNoonHour, solarNoonMinute, solarNoonSecond)
    #solarNoon = str(solarNoonHour).zfill(2)+":"+str(solarNoonMinute).zfill(2)+":"+str(solarNoonSecond).zfill(2)
    ...
    solarNoon = datetime.combine(solarNoonDate , solarNoonHMS)
    ...
    return {"sunrise":{"datetime":sunrise, "sunrise_time":sunriseHMS, "solarazimuth":solarAzimuthAngleSunrise}, "solarNoon":{"datetime":sunset, "solarNoon_time":solarNoonHMS, "solarazimuth":solarAzimuthAngleSolarNoon}, "sunset":{"datetime":sunset, "sunset_time":sunsetHMS, "solarazimuth":solarAzimuthAngleSunset}}
